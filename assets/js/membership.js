const sheetLink = "https://docs.google.com/spreadsheets/d/e/2PACX-1vR3J_fdWqUJq8wcvE_M-VSxy6cGxh6gl2nCEwuT--vxG_5O54ZZxJ0Ix_yziQZE4iXi4wyhHrG4qZwz/pubhtml?gid=0&single=true";
...
request.onreadystatechange = function() {
  if (request.readyState == 4) {
    ...
    for (let i = 0; i < sheet.length; i++) {
      ...
      grade.appendChild(document.createTextNode(original[3].innerText));
      row.appendChild(grade);
      // points
      const points = document.createElement("td");
      points.appendChild(document.createTextNode(original[4].innerText));
